...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		line_2 = GLine(upper_left_x+length*0.5, upper_left_y+length*0.866, upper_left_x+length, upper_left_y)
		line_3 = GLine(upper_left_x, upper_left_y, upper_left_x + length, upper_left_y)

		window.add(line_1)
		window.add(line_2)
		window.add(line_3)

		# Triangle start at upper_left_x,upper_left_y
		sierpinski_triangle(order - 1, length / 2, upper_left_x, upper_left_y)
		# Triangle start at upper_left_x+length/2,upper_left_y
		sierpinski_triangle(order - 1, length / 2, upper_left_x + length / 2, upper_left_y)
		# Triangle start at upper_left_x+length/4,upper_left_y+ length * 0.866 / 2
