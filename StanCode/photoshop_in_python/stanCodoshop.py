...
def get_average(pixels):
    ...
    for pixel in pixels:
        ...
        count += 1
    avg_list = [red_total // count, green_total // count, blue_total // count]
    return avg_list


def get_best_pixel(pixels):
    """
    Given a list of pixels, returns the pixel with the smallest "color distance", which has the closest color to
    the average.
    Input:
    ...
    best = sorted(pixels, key=lambda pixel: get_pixel_dist(pixel, avg_pixel[0], avg_pixel[1], avg_pixel[2]))
    return best[0]
...
def solve(images):
    ...
    Returns:
        best image without people or bicycle
    """
